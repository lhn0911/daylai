<template>
  <div class="sidebar" v-if="enterprise">
    <div class="user-info">
      <img
      ...
      />
      <div>
        <div class="user-name">{{ enterprise.introduction }}</div>
        <div class="user-text">{{ enterprise.emailEnterprise }}</div>
      </div>
    </div>
    <div class="divider"></div>
    <nav class="nav-menu">
      <div class="nav-item" :class="{ active: isActive('basic-info') }">
        <router-link
          to="/enterprise/basic-info"
          @click="setActive('basic-info')"
          class="link-item"
        >
          <div class="icon-wrapper">
            ...
            >
              ...
              />
              <path
                d="M15.8346 13.9583H14.168C13.8263 13.9583 13.543 13.675 13.543 13.3333C13.543 12.9917 13.8263 12.7083 14.168 12.7083H15.8346C16.1763 12.7083 16.4596 12.9917 16.4596 13.3333C16.4596 13.675 16.1763 13.9583 15.8346 13.9583Z"
                fill="#2D2C2C"
              />
              <path
                d="M7.08255 10.0333C5.90755 10.0333 4.94922 9.07499 4.94922 7.9C4.94922 6.725 5.90755 5.76666 7.08255 5.76666C8.25755 5.76666 9.21589 6.725 9.21589 7.9C9.21589 9.07499 8.25755 10.0333 7.08255 10.0333ZM7.08255 7.01666C6.59922 7.01666 6.19922 7.41666 6.19922 7.9C6.19922 8.38333 6.59922 8.78333 7.08255 8.78333C7.56589 8.78333 7.96589 8.38333 7.96589 7.9C7.96589 7.41666 7.56589 7.01666 7.08255 7.01666Z"
                fill="#2D2C2C"
              />
              <path
                d="M10.0009 14.2333C9.68423 14.2333 9.40923 13.9917 9.3759 13.6667C9.28423 12.7667 8.55923 12.0417 7.6509 11.9583C7.26757 11.925 6.88423 11.925 6.5009 11.9583C5.59257 12.0417 4.86757 12.7583 4.7759 13.6667C4.74257 14.0083 4.43423 14.2667 4.09256 14.225C3.7509 14.1917 3.5009 13.8833 3.53423 13.5417C3.68423 12.0417 4.8759 10.85 6.38423 10.7167C6.84257 10.675 7.30923 10.675 7.76756 10.7167C9.26756 10.8583 10.4676 12.05 10.6176 13.5417C10.6509 13.8833 10.4009 14.1917 10.0592 14.225C10.0426 14.2333 10.0176 14.2333 10.0009 14.2333Z"
                fill="#2D2C2C"
              />
            </svg>
          </div>
      ...
      <div class="nav-item" :class="{ active: isActive('jobs') }">
        <router-link
          to="/enterprise/jobs"
      ...
      <div class="nav-item" :class="{ active: isActive('interviews') }">
        <router-link
          to="/enterprise/interviews"
          @click="setActive('interviews')"
          class="link-item"
        >
          <div class="icon-wrapper">
            <svg
...
const activeItem = ref("basic-info");
// Hàm set active item
